 ...
 * @generated
 */
@ImplementationClassName("com.rivetlogic.skype.model.impl.SkypeGroupImpl")
@ProviderType
public interface SkypeGroup extends SkypeGroupModel, PersistedModel {
	 ...
	 */
	public static final Accessor<SkypeGroup, Long> SKYPE_GROUP_ID_ACCESSOR = new Accessor<SkypeGroup, Long>() {
			@Override
			public Long get(SkypeGroup skypeGroup) {
				return skypeGroup.getSkypeGroupId();
			}
			...
			@Override
			public Class<SkypeGroup> getTypeClass() {
